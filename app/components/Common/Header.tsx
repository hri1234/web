...
const Header = ({user}:HeaderProps) => {
  ...
  return (
    <header className="grid grid-cols-2 py-2 px-4 md:px-12 items-center sticky top-0 z-10 bg-#F8F9FA">
      {/* Left Area  */}
      ...
      <div className="hidden md:flex  items-center justify-end space-x-4">
        ...
        <Link
          href="/cart"
          className="relative p-2 bg-slate-200 rounded-full text-gray-500 hover:bg-green-200 hover:text-green-600 " style={{backgroundColor:"black", color:"white"}}
        >
        ...
        <button className="bg-pink text-black-500 px-4 py-1 rounded-full"
        onClick={onOpen}
      style={{backgroundColor:"#FF006B" , color:"black"}}  >
          Login/Signup
        </button>
          )
        }
